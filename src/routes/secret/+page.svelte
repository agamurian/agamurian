...
<svelte:head>
	<title>Notes - Andrey Golovin</title>
	<meta name="description" content="Notes and not yet published docs." />
</svelte:head>
...
<section>
	...
	<div class="featured-posts">
		{#each filteredPosts.filter(p => p.featured) as post}
			<a href="/secret/{post.slug}" class="featured-card">
	...
	<div class="posts-list">
		{#each filteredPosts as post}
			<article class="post-item">
				<a href="/secret/{post.slug}" class="post-link">
